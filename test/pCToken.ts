...
describe("PCToken", function() {
    ...
    describe("transfer", async() => {
        ...
        it("Should emit transfer event", async() => {
            await pcToken.mint(account, constants.WeiPerEther);
            await expect(pcToken.transfer(account2, constants.WeiPerEther)).to.emit(pcToken, 'Transfer').withArgs(account, account2, constants.WeiPerEther);
        });
    ...
    describe("approve", async() => {
        it("Should emit event", async() => {
            await expect(pcToken.approve(account2, constants.WeiPerEther)).to.emit(pcToken, "Approval").withArgs(account, account2, constants.WeiPerEther);
        });
    ...
    describe("increaseApproval", async() => {
        it("Should emit event", async() => {
            await expect(pcToken.increaseApproval(account2, constants.WeiPerEther)).to.emit(pcToken, "Approval").withArgs(account, account2, constants.WeiPerEther);
        });
        it("Should work when there was no approved amount before", async() => {
    ...
    describe("decreaseApproval", async() => {
        ...
        it("Should emit event", async() => {
            await expect(pcToken.decreaseApproval(account2, constants.WeiPerEther)).to.emit(pcToken, "Approval").withArgs(account, account2, constants.Zero);
        });
    ...
    describe("transferFrom", async() => {
        ...
        it("Should emit event", async() => {
            ...
            await expect(pcToken.transferFrom(account, account2, constants.WeiPerEther)).to.emit(pcToken, 'Transfer').withArgs(account, account2, constants.WeiPerEther);
        });
        ...
        it("Should fail when sender does not have enough balance", async() => {
            ...
            pcToken = pcToken.connect(signers[1]);
            await expect(pcToken.transferFrom(account, account2, constants.WeiPerEther.add(1))).to.be.reverted;
        });
