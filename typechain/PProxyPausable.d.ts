...
export class PProxyPausable extends Contract {
  ...
  addListener(eventName: EventFilter | string, listener: Listener): PProxyPausable;
  ...
  functions: {
    ...
    renouncePauzer(overrides?: TransactionOverrides): Promise<ContractTransaction>;
    ...
    setPaused(_value: boolean, overrides?: TransactionOverrides): Promise<ContractTransaction>;

    setPauzer(_newPauzer: string, overrides?: TransactionOverrides): Promise<ContractTransaction>;
