...
export class TestReentryProtectionFactory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): TestReentryProtection {
    return new Contract(address, _abi, signerOrProvider) as TestReentryProtection;
  }
}
