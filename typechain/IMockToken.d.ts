...
interface IMockTokenInterface extends Interface {
  functions: {
...
export class IMockToken extends Contract {
  connect(signerOrProvider: Signer | Provider | string): IMockToken;
  attach(addressOrName: string): IMockToken;
  deployed(): Promise<IMockToken>;

  on(event: EventFilter | string, listener: Listener): IMockToken;
  once(event: EventFilter | string, listener: Listener): IMockToken;
  addListener(eventName: EventFilter | string, listener: Listener): IMockToken;
  removeAllListeners(eventName: EventFilter | string): IMockToken;
  removeListener(eventName: any, listener: Listener): IMockToken;
