...
interface IBPoolInterface extends Interface {
  functions: {
    bind: TypedFunctionDescription<{
      encode([token, balance, denorm]: [string, BigNumberish, BigNumberish]): string;
    }>;

    calcPoolInGivenSingleOut: TypedFunctionDescription<{
      encode([tokenBalanceOut, tokenWeightOut, poolSupply, totalWeight, tokenAmountOut, swapFee]: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    calcPoolOutGivenSingleIn: TypedFunctionDescription<{
      encode([tokenBalanceIn, tokenWeightIn, poolSupply, totalWeight, tokenAmountIn, swapFee]: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    calcSingleInGivenPoolOut: TypedFunctionDescription<{
      encode([tokenBalanceIn, tokenWeightIn, poolSupply, totalWeight, poolAmountOut, swapFee]: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    calcSingleOutGivenPoolIn: TypedFunctionDescription<{
      encode([tokenBalanceOut, tokenWeightOut, poolSupply, totalWeight, poolAmountIn, swapFee]: [
        BigNumberish,
        BigNumberish,
        BigNumberish,
        BigNumberish,
...
export class IBPool extends Contract {
  ...
  functions: {
    ...
    gulp(token: string, overrides?: TransactionOverrides): Promise<ContractTransaction>;
    ...
    setController(manager: string, overrides?: TransactionOverrides): Promise<ContractTransaction>;
    ...
    unbind(token: string, overrides?: TransactionOverrides): Promise<ContractTransaction>;
  };
  ...
  setSwapFee(swapFee: BigNumberish, overrides?: TransactionOverrides): Promise<ContractTransaction>;
  ...
  estimate: {
    bind(token: string, balance: BigNumberish, denorm: BigNumberish): Promise<BigNumber>;
    ...
    rebind(token: string, balance: BigNumberish, denorm: BigNumberish): Promise<BigNumber>;
